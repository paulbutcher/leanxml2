...
public def Handle : Type := HandleImpl.type
public instance : Nonempty Handle := HandleImpl.property
end Doc
...
public opaque readMemory (contents url : @& String) : IO Doc.Handle

@[extern "lean_xml_read_file"]
public opaque readFile (path : @& String) : IO Doc.Handle

@[extern "lean_xml_doc_is_null"]
public opaque docIsNull (h : @& Doc.Handle) : IO Bool

@[extern "lean_xml_doc_root"]
public opaque docRoot (h : @& Doc.Handle) : IO USize

@[extern "lean_xml_doc_dump"]
public opaque docDump (h : @& Doc.Handle) : IO String

@[extern "lean_xml_node_dump"]
public opaque nodeDump (h : @& Doc.Handle) (n : USize) : IO String

@[extern "lean_xml_node_type"]
public opaque nodeType (n : USize) : IO UInt32

@[extern "lean_xml_node_name"]
public opaque nodeName (n : USize) : IO String

@[extern "lean_xml_node_content"]
public opaque nodeContent (n : USize) : IO String

@[extern "lean_xml_node_first_child"]
public opaque nodeFirstChild (n : USize) : IO USize

@[extern "lean_xml_node_next"]
public opaque nodeNext (n : USize) : IO USize

@[extern "lean_xml_node_prev"]
public opaque nodePrev (n : USize) : IO USize

@[extern "lean_xml_node_parent"]
public opaque nodeParent (n : USize) : IO USize

@[extern "lean_xml_node_ns_href"]
public opaque nodeNsHref (n : USize) : IO String

@[extern "lean_xml_node_ns_prefix"]
public opaque nodeNsPrefix (n : USize) : IO String

@[extern "lean_xml_node_attr_count"]
public opaque nodeAttrCount (n : USize) : IO UInt32

@[extern "lean_xml_node_attr_name"]
public opaque nodeAttrName (n : USize) (i : UInt32) : IO String

@[extern "lean_xml_node_attr_ns_href"]
public opaque nodeAttrNsHref (n : USize) (i : UInt32) : IO String

@[extern "lean_xml_node_attr_value"]
public opaque nodeAttrValue (n : USize) (i : UInt32) : IO String

@[extern "lean_xml_has_prop"]
public opaque hasProp (n : USize) (name : @& String) : IO Bool

@[extern "lean_xml_get_prop"]
public opaque getProp (n : USize) (name : @& String) : IO String

@[extern "lean_xml_has_ns_prop"]
public opaque hasNsProp (n : USize) (name namespaceHref : @& String) : IO Bool

@[extern "lean_xml_get_ns_prop"]
public opaque getNsProp (n : USize) (name namespaceHref : @& String) : IO String

/-- `prefix = ""` searches for the default namespace, matching libxml2's own
`NULL`-means-default convention. -/
@[extern "lean_xml_search_ns"]
public opaque searchNs (h : @& Doc.Handle) (n : USize) (nsPrefix : @& String) : IO String

@[extern "lean_xml_error_count"]
public opaque errorCount : IO UInt32

@[extern "lean_xml_error_message"]
public opaque errorMessage (i : UInt32) : IO String

@[extern "lean_xml_error_domain"]
public opaque errorDomain (i : UInt32) : IO UInt32

@[extern "lean_xml_error_code"]
public opaque errorCode (i : UInt32) : IO UInt32

@[extern "lean_xml_error_line"]
public opaque errorLine (i : UInt32) : IO UInt32

@[extern "lean_xml_clear_errors"]
public opaque clearErrors : IO Unit

@[extern "lean_xml_xpath_new_context"]
public opaque xpathNewContext (h : @& Doc.Handle) : IO USize

@[extern "lean_xml_xpath_free_context"]
public opaque xpathFreeContext (ctx : USize) : IO Unit

@[extern "lean_xml_xpath_register_ns"]
public opaque xpathRegisterNs (ctx : USize) (nsPrefix href : @& String) : IO Bool

@[extern "lean_xml_xpath_eval"]
public opaque xpathEval (ctx : USize) (expr : @& String) : IO USize

@[extern "lean_xml_xpath_free_object"]
public opaque xpathFreeObject (obj : USize) : IO Unit

@[extern "lean_xml_xpath_is_nodeset"]
public opaque xpathIsNodeSet (obj : USize) : IO Bool

@[extern "lean_xml_xpath_node_count"]
public opaque xpathNodeCount (obj : USize) : IO UInt32

@[extern "lean_xml_xpath_node_at"]
public opaque xpathNodeAt (obj : USize) (i : UInt32) : IO USize
